...
Below is the example of program output, you could see that the value is decreasing, although not uniformly -- in ~10% of times the value in fact is increasing:
